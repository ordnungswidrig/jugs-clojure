(defproject jugsclojure "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "jugsclojure.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main jugsclojure.server
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "jugsclojure.core/on-figwheel-reload"}

                :compiler {:main jugsclojure.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/jugsclojure.js"
